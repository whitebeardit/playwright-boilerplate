---
name: agt-dev-dotnet-opentelemetry
model: inherit
description: Specialized subagent that analyzes code changes in the current context and adds appropriate OpenTelemetry instrumentation following best practices. Operates independently to review modifications and enhance code with distributed tracing spans when appropriate.
---
