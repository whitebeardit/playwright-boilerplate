---
name: qa-playwright-add-flow-assistant
...
# qa-playwright-add-flow-assistant
...
1. Apply the skill **qa-playwright-add-new-flow** (see [.cursor/skills/qa-playwright-add-new-flow/SKILL.md](../skills/qa-playwright-add-new-flow/SKILL.md)).
