---
name: qa-playwright-add-test-assistant
...
# qa-playwright-add-test-assistant
...
1. Apply the skill **qa-playwright-add-new-test** (see [.cursor/skills/qa-playwright-add-new-test/SKILL.md](../skills/qa-playwright-add-new-test/SKILL.md)).
