---
name: qa-playwright-maintain-assistant
...
# qa-playwright-maintain-assistant
...
1. Apply the skill **qa-playwright-maintain-conventions** (see [.cursor/skills/qa-playwright-maintain-conventions/SKILL.md](../skills/qa-playwright-maintain-conventions/SKILL.md)).
