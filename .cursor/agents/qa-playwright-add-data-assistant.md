---
name: qa-playwright-add-data-assistant
...
# qa-playwright-add-data-assistant
...
1. Apply the skill **qa-playwright-add-test-data** (see [.cursor/skills/qa-playwright-add-test-data/SKILL.md](../skills/qa-playwright-add-test-data/SKILL.md)).
